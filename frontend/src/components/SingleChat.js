...
const ENDPOINT = "http://localhost:5000"; // ! change before deployment
var socket, selectedChatCompare;

let encryptor = new JSEncrypt();
let decryptor = new JSEncrypt();
encryptor.setPublicKey(process.env.REACT_APP_PUBLIC_KEY);
// Set the private key
decryptor.setPrivateKey(process.env.REACT_APP_PRIVATE_KEY);
